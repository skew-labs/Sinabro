//! Evidence bundle index reference.
//!
//! Public surface: [`StageCEvidenceRef`].
//!
//! # Invariants
//!
...
//! * **No re-mint.** The trace reuses [`StageCTraceLink`]; no parallel trace
//!   type is introduced.
//!
//! These refs are the content-addressed anchors the `a-core` logging / trace
//! surface points at. The hashing itself is done by the evidence producer; this
//! type stores and verifies the result.
...
/// A content-addressed reference to one Stage C evidence file.
