//! Read-only canary monitor.
//!
//! A read-only monitor for package / blob / gas / sponsor status.
//!
//! # Invariants
//!
...
//! # Related
//!
//! * Anomalies are counted into the
//!   [`MetricsExporter`](crate::metrics::MetricsExporter) as
