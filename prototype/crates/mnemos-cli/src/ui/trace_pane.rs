//! Paged trace / memory pane.
//!
//! The operational pane wraps the [`TracePane`] with the paging controls a
...
//! invariant `true`; the hot path never blocks). This module performs no I/O.
//!
//! The fold / redaction / bounded paging is reused from
...
/// An operational paged view over a [`TracePane`] (trace output or a
