...
//! body, or private memory — only hashes, ids, and bounded flags. A draft
//! from a non-reproduced
//! receipt, or one missing the remediation or source anchor, is refused. This
//! module performs no live action.
//!
//! Secret custody: the [`AuditReportDraft`] type has no field
...
//! [`crate::audit::repro_receipt::LocalReproRunnerReceipt`]; the canonical
