//! Audit evidence bundle export (atom #536 · G.4.5).
//!
...
//! or an `Option` of a secret-zero record (`G-G-AUDIT-GAME-TREE`,
//! `G-G-EVIDENCE-MANIFEST`). This module performs no live action.
//!
//! Live-export boundary (`G-G-EVIDENCE-MANIFEST`): mirroring
...
//! (#521), [`LocalReproRunnerReceipt`] (#526), [`AuditReportDraft`] (#528),
//! [`DefendedInvariantMemory`] (#527).
