//! Local repro plan (atom #520 · G.3.4).
//!
...
//! refused (`G-G-AUDIT-GAME-TREE`). This module performs no live action.
//!
//! Reuse (no reinvention): mirrors the Stage E local-repro signal; a reproduced
