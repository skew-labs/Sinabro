//! Web-search tool surface status.
//!
//! A status projection over the web-source policy: web research is opt-in
...
//! is `true`). This module performs no
//! live action.
//!
...
//! [`crate::commands::tool`] (`WebResearchRecord` / `web_answer_allowed`).
