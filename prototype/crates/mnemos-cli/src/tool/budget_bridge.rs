//! Operational tool-adapter budget bridge (atom #503 · G.1.12).
//!
//! Stage F minted the normalized [`ToolCallView`] (adapter + capabilities +
//! sandbox tier + risk + approval + state) and the [`BudgetCap`] ledger. Stage G
//! *bridges* them: every Python / MCP / CLI / HTTP / WASM tool call shares one
