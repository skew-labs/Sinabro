//! Operational task/session inbox integration.
//!
...
//! and checkpointable state. Each operational job
//! class maps onto a canonical [`JobKind`] — this integration adds no new job-kind truth.
//!
...
/// The operational job classes that share one task/session inbox. Each
/// maps onto a canonical [`JobKind`] (this integration mints no new job-kind truth).
#[repr(u8)]
...
/// Bounded-concurrency admission control for full-job generations. Caps the
