//! Operational daemon supervisor view.
//!
...
//! Degraded / stuck / lockdown states are visible and
//! killable; a stopped daemon renders `Unknown`, never a false green.
//!
//! Reuse (no reinvention): the supervisor concept is the
//! [`mnemos_a_core`] runtime supervisor + the daemon status; the
