//! Operational control-express bypass.
//!
...
//! the queue). The additional controls (provider freeze, wallet/gas hard stop) ride
...
impl ExpressClass {
    ...
    /// Map onto the canonical [`ExpressControl`] rail. The additional controls
    ...
    /// Every express class bypasses the normal / background queues (reuses the
    /// express rail's total bypass property).
    #[must_use]
