//! §4.3 cockpit trace pane + output fold (atom #421 F.2.4).
//!
...
/// §4.3 — the source kind of a trace, which selects the specialized compressor.
#[repr(u8)]
...
/// §4.3 — one displayed line of a folded trace.
...
/// §4.3 — a folded, redacted, paged view of one command's output.
#[derive(Clone, Debug, PartialEq, Eq)]
