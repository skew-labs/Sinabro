//! Gas Station drain invariant dashboard tab.
//!
//! A pure projection (like the rest of [`crate::tui`]) of the Gas Station
//! drain-prevention invariants. Each invariant the threat model
...
/// The drain-prevention invariant gates, in dashboard display order.
#[repr(u8)]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum DrainGateKind {
    /// "Any valid tx within budget is sponsored" — strictly forbidden.
...
/// Every drain gate, in display order. Used by the dashboard + coverage
...
/// The Gas Station drain invariant dashboard — a list of drain-gate rows.
...
/// The hot-wallet drain bound: the hot sponsor wallet's standing balance cap
