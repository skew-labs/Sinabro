//! Multimodal / image input — local-vision-first.
//!
...
//!
//! custody/funds/wallet/chain-write are HARD-LOCKED: an image path touches none.
...
/// The LOCAL image-as-READ-context pipeline: read + classify the image,
...
/// The FRONTIER-IMAGE egress PREPARE. REQUIRES an [`EgressCapability`]
