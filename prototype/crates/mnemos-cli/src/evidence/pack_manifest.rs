...
//! memory. This module performs no live action.
//!
//! Reuse (no reinvention): the evidence-lake anchor is the
//! [`EvidenceLakeReceipt`] (`manifest_hash_32`); a command-trace entry is built
//! from the [`CommandTraceRecord`] (`redacted_output_hash_32`).
...
impl EvidencePackEntry {
    ...
    /// A [`EvidenceKind::CommandTrace`] entry from a [`CommandTraceRecord`]
...
impl EvidencePackBuilder {
    ...
    /// Anchor the pack to an [`EvidenceLakeReceipt`] (records the receipt's
