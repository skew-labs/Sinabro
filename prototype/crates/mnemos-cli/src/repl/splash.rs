//! Startup splash — ratatui one-shot, rendered into scrollback (G-WP-12 / 12-B).
//!
...
//! operational views stay clean (`G_TERMINAL_DESIGN_CONTRACT` §3.1 splash-banner
//! exception).
//!
...
//!
//! Honesty (Phase-0): unlike a live agent (Hermes' `browser` / `code_execution`
