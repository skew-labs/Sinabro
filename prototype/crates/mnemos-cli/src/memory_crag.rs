//! `memory_crag` — the P-RAG corrective-retrieval layer (W4 Slice 2; plan
//! `ops/evidence/stage_g/agent_loop/P1_MULTI_EXPERT_ARCHITECTURE.md` §5).
//!
...
//!
//! ## the trust flag is the on-disk truth, not a new field (W3 "pin what compiles")
//!
...
/// fetch tries them (owner: "메인은 walrus, walrus 안되면 0g"): Walrus is PRIMARY, 0G
/// is the FALLBACK. Pure / deterministic.
