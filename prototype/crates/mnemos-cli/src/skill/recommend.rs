//! Skill recommend / use / install dry-run surface (atom #541 · G.4.10).
//!
...
//! [`SkillInstallDryRun::is_commerce`] are always `false` (`G-G-TRUST-BOUNDARY-DIET`,
//! No-Commerce). This module performs no live action.
//!
