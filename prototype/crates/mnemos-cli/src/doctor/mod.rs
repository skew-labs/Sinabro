...
/// MEASURED `secret_zero`. Scan the doctor-visible local
/// surfaces with the canonical secret engine
...
/// MEASURED `safety_kernel_intact`. A runtime self-test that
