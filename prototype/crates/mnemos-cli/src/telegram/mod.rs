...
//!
//! Stage F ([`crate::commands::platform_telegram`]) minted the Telegram
...
//!   module only RECEIVES + PARSES (authentication and the unforgeable capability mint live elsewhere).
//!
