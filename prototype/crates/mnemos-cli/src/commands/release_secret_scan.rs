//! Open-source release secret-baking scan.
//!
...
//!
//! Reuse: the scanner + counts report are the canonical
...
/// The release surfaces that must all be secret-clean before ship.
#[repr(u8)]
