//! 5-tier capability diff (atom #435 F.4.0).
//!
//! `sinabro capability diff`. Every tool / skill install or run shows a
//! capability diff *before* execution (`G-F-CAPABILITY`): what is added, what is
...
//! denied.
//!
//! Reuse (no reinvention): mirrors Stage A's `CapabilityKind` and the Stage D
