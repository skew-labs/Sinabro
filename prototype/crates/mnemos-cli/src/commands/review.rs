//! `sinabro review` — SDK / public-docs / review-queue controls (atom #463 ·
//! F.7.4 SDK/public docs/review queue controls).
//!
...
//! (atom #463 criterion: local status p95 ≤ 100ms).
...
/// first-success-before-philosophy order (atom #463 광기).
