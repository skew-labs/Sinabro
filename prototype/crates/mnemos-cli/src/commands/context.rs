//! Context map + the `context` command model.
//!
...
//! kinds). The completion provider half lives in [`crate::repl::complete`].
...
/// The summary view of the context map.
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
