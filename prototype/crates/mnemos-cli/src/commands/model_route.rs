//! model route / fallback diff display.
//!
...
impl ConsultTrigger {
    /// All typed consult triggers — the COMPLETE evidence-backed set.
...
///
/// NOTE: the amendment wrote "8k/2k/16k/4k/12k" without
...
/// One unhealthy trajectory signal. Each value is
