//! `memory compact / importance / user-model` intelligence status.
//!
//! Read-only projections over the canonical memory-intelligence types
...
pub struct CompactorStatusView {
    ...
    /// Redacted 16-hex prefix of the preserved transcript anchor.
