//! Persisted, hash-linked audit trail (ENDGAME).
//!
...
//! [`AuditEntry::seal_bytes_105`]; the directory is the [`data_dir`]; the
...
mod tests {
    ...
    /// equal the independent Python derivation (byte-format lock). If either
