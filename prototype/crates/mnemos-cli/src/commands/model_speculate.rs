//! Speculation status view (atom #431 F.3.4).
//!
...
//! local verification (`G-F-SAFETY`, `G-F-ADAPTIVE-ROUTER`).
//!
...
/// The canonical G-WP-09 speculative-decoding draft model id — a small fast
/// proposer (Qwen2.5-Coder-1.5B).
pub const SPECULATION_DRAFT_MODEL_ID: &str = "Qwen2.5-Coder-1.5B";

/// The canonical G-WP-09 speculative-decoding verify model id — the larger target
...
impl SpeculationIdentity {
    ...
    /// The canonical G-WP-09 draft/verify identity. The draft proposer is the
