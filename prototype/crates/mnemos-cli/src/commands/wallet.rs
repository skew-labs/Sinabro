...
//! identity (F-WP-05C, atom #446 · F.5.3 wallet connect/zklogin/status).
//!
...
//!   [`MemoryOwnerBinding::owner_is_not_sponsor`] (the atom #443 separation rule,
//!   re-asserted at the wallet surface).
...
/// Scan rendered / log lines for live-shaped secret material — the atom #446 key
