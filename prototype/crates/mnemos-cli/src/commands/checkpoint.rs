//! checkpoint / restore command (atom #470 · F.8.3, part 1 of 2).
//!
...
//! write happens without a recorded restore point (`G-F-CHECKPOINT`). A restore
...
//!
//! Reuse (no reinvention): the file-changing risk classes are the canonical
