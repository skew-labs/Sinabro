//! Operational bounded frontier-consult request.
//!
//! [`ModelRouter::consult_packet`] (which builds a
...
//! file-sidecar / private-memory inclusion) are composed here into a single
...
//!
//! Live-boundary custody (secret-zero; cost-budget bounded; default dry-run /
//! no-live): the request is **disabled by default** —
...
//! separate same-message approval ceremony (none by default), and even then
