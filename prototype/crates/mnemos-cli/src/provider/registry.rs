//! Operational provider registry candidate view (atom #491 · G.1.0).
//!
//! Stage F ([`crate::commands::provider`]) registers *configured attachments*
//! with secret references for the `provider add/list/test` CLI surface. Stage G
...
//! enabled at registration, is rejected (`G-G-BASE-PROVENANCE`). No weight
//! training is performed (`G-G-NO-TRAINING-IN-G`).
//!
