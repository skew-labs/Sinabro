//! Operational route FSM + per-state effect mapping.
//!
//! [`RouteExecutionState`] (the FAST/NORMAL/SLOW/STUCK/AUDIT/
//! LOCKDOWN/USER_FULL enum) and [`ModelRouter`] (transition with hysteresis /
//! no-flap + `escalate_if_stuck`) back the *operational effect mapping* this
//! module adds:
