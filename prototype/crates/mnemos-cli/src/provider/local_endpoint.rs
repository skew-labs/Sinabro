...
//! (G-WP-09 atoms #594 G.8.0, #597 G.8.3).
//!
...
//!
//! ENDGAME E2-1 DISK-TRUTH (2026-06-12): this trait + its [`GenStream`] are
...
//! only by their own tests). The LIVE local-generation path is the P3-3 CONSULT
...
//! E7 STREAMING seam; E2 does NOT wire a producer nobody reads (PD-1 no-hollow-
//! label; owner-ratified 2026-06-12). The autonomy default routes to the LIVE
//! local consult via [`crate::provider::route_select`] (E2-2), not this seam.
//!
...
/// tools still run — but that consumer is the E7 STREAMING seam and does NOT
/// exist yet (E2-1 disk-truth; see the module docs).
#[derive(Clone, Debug)]
