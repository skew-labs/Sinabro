...
//! (chain 16602) that binds the oracle-verified pattern (`dataHash` = the anchored
...
//! the /split. `CustodyCapability` stays uninhabited; names no custody.
//!
...
//! verified pattern), NOT per-user correctness — the same aggregate boundary as.
...
/// The seam-locked provenance descriptor — names the expert + the
...
/// seam-locked descriptor + the reused patternHash).
#[must_use]
...
// ===========================================================================
// capstone — mint a FINE-TUNED EXPERT as an iNFT ("the adapter IS the intelligence")
// ===========================================================================
