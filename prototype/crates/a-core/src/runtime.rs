//! Async runtime supervisor for MNEMOS.
//!
//! # Design rationale
//!
...
//! once an outside-the-process boundary has been
...
// ---------------------------------------------------------------------------
// Public enums — 11 #[repr(u8)] variants.
// ---------------------------------------------------------------------------
...
/// debug surfaces (the redaction model never exposes raw values, so
