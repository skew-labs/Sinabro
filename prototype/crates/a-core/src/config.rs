//! `config.rs` — typed runtime configuration (atom #5 · A.0.5).
//!
//! # Why this madness
//!
...
//!
//! Reuse: [`MnemosError`], [`MnemosResult`], [`SafeErrorReport`] (atom #2).
...
impl RuntimeConfig {
    ...
    pub fn from_toml_str(
        ...
        // 광기: mainnet label refusal (no network call).
        ...
        // 광기: banned command names (regardless of run-disabled).
