//! Stage C chain-environment matrix (C-WP-01 · atom #173 · C.0.2).
//!
//! Canonical OUT (§4.1): [`StageCChainEnv`], [`MainnetExecutionState`].
//!
//! # Madness invariants
//!
...
//!   ceremony built in later C-WP packages (multisig + timelock + operator
//!   approval). This atom performs **no live egress**.
...
/// C-WP packages; [`Paused`](Self::Paused) is the incident-pause sink.
#[derive(Clone, Copy, Debug, Eq, PartialEq, Hash)]
#[repr(u8)]
