//! Tamper-evident dataset shard writer.
//!
//! # Rationale
//!
...
/// An evidence-lake receipt: the on-disk anchor that ties a shard's manifest
...
/// A dataset shard manifest: the tamper-evident header for one shard.
#[derive(Clone, Copy, Debug, Eq, PartialEq, Hash)]
