//! Fine-Grained Optimization (FGO) AST coverage mask (atom #391 · E.3.5, §4.5
//! `FgoCoverageMask`).
//!
//! # Madness
//!
//! The mask weights **executed** added tokens high and **unexecuted** added
//! tokens low, and is tied to the diff hash and the coverage evidence. The §4.4
...
/// An FGO coverage mask (§4.5 `FgoCoverageMask`).
