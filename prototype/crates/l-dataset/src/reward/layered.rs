//! Layered Reward labels (atom #389 · E.3.3, §4.5 `LayeredRewardLabel`,
//! `RewardMilli`).
//!
//! # Madness
//!
...
//!
//! ## Secret custody (physics warning 389 resolution)
//!
...
/// The discrete reward scalar (§4.5 `RewardMilli`), in milli-units.
...
/// The eight hard nullifiers that block any positive reward (§4.5 madness).
...
/// A layered reward label (§4.5 `LayeredRewardLabel`).
#[derive(Clone, Copy, Debug, Eq, PartialEq, Hash)]
