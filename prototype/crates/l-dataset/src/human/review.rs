//! Human review schema (atom #374 · E.2.3, §4.4 `HumanReviewSignal`).
//!
//! Re-exports the canonical §4.4 [`HumanReviewSignal`] (defined in
...
/// Aggregate parsed reviews into the canonical §4.4 [`HumanReviewSignal`].
