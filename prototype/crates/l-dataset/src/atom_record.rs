//! AtomDietRecord assembler (atom #348 · E.0.17, §4.1).
//!
...
/// One source atom rendered as a typed, hash-pinned record (§4.1).
...
impl AtomDietRecord {
    /// Whether this record is training/reward eligible. Always `false` in
    /// E-WP-01: eligibility is recomputed by a later WorkPackage only after S1
    /// reverify and a privacy pass. Dataset-build never grants reward.
