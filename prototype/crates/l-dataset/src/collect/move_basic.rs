//! Move build/test signal (atom #356 · E.1.5, §4.4 `MoveSignal`).
//!
...
//! (the deep prover/spec surface is atom #357); `gas_hash_32` is the gas anchor
//! filled by atom #358 and is the `"none"` sentinel here.
...
/// Move build/test signal (§4.4 `MoveSignal`).
...
pub struct MoveSignal {
    ...
    pub test_pass: bool,
    /// `G-MOVE-PROVER` was an explicit pass (deep prover surface is atom #357).
    pub prover_pass: bool,
    /// Gas anchor — `sha256("none")` until atom #358 fills it.
