//! PII / secret scanner pipeline (atom #381 · E.2.10).
//!
//! # Custody / live-boundary proof (physics warnings 381 resolution)
//!
...
//! is reported as a *count*, then handed to the redaction policy (#382) or
