//! Bounded chunk-frame stream for `c-walrus` (atom #11 · C.0.5).
//!
//! # Wire format (canonical, reuses atom #7 `wire` primitives)
//!
...
//!   field (the public struct shape pinned in §4.C has exactly three
...
//!   behavior §10.1 forbids; callers are expected to choose a finite cap.
...
//     in `tests/stream.rs` per ATOM_PLAN line 903).
// ===========================================================================
