//! BCS chunk envelope V1 codec for `c-walrus` (atom #7 · C.0.1).
//!
...
//! ```
//!
//! `MIN_EMPTY_CHUNK_V1_BYTES = 10` (matches the constant pinned in §4.C; all
...
/// verifier in `c-walrus::blob_id` (C.0.4) and `mnemos-g-wallet`.
#[derive(Clone, Copy, Debug, Eq, PartialEq)]
#[repr(C)]
...
/// publisher-reported text), enforced by `c-walrus::blob_id::VerifiedBlobId`
/// in atom C.0.4 once it lands.
#[derive(Clone, Copy, Debug, Eq, PartialEq, Hash)]
#[repr(C)]
