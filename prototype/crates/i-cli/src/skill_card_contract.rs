//! `mnemos-i-cli::skill_card_contract` — atom #305 · D.3.9 — the CLI-first card
//! data contract.
//!
...
//!
//! No-commerce (#305, G-D-NO-COMMERCE): none of the twelve commands is a
...
//!
//! Reuses the #298–#304 catalog card types from `mnemos-e-skill` (the single new
...
impl SkillCliCommand {
    ...
    /// the permission delta is never hidden (#301).
    #[must_use]
...
pub struct SkillCardContract {
    ...
    /// The lightweight listing card (#298).
