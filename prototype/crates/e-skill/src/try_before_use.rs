//! `mnemos-e-skill::try_before_use` — atoms #266 / #267 · D.1.10 / D.1.11 —
//! the try-before-use dry-run surface.
//!
//! ## Canonical OUT (§4.2)
//!
//! - [`TryBeforeUseFixture`] (#266) — the declarative fixture envelope a dry-run
...
//! - [`TryBeforeUseRun`] (#267) — the dry-run result: skill, package digest,
...
/// §4.2 declarative fixture envelope for a dry-run. In-memory only; using it
...
/// §4.2 dry-run result. Records what was trialed and the decision/trace; it can
