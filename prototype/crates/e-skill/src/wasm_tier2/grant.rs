...
//! deny-labels with no [`CapabilityKind`] projection ([`Self::a_capability`]
...
// ===========================================================================
// 1. WasmCapabilityGrant — single-permission, four-axis-scoped grant
// ===========================================================================

/// Single-permission capability grant. Owner-scoped, skill-scoped,
...
impl WasmCapabilityGrant {
    ...
    /// The [`CapabilityKind`] this grant's permission projects to, if any.
    /// Memory/anchor permissions map to a capability; file / network /
    /// wallet / chain / secret / tool permissions project to `None` — a grant
    /// for them confers no capability and the sandbox denies their execution.
    #[inline]
    #[must_use]
...
// ===========================================================================
// 2. ScopedSkillCapabilityToken — package-bound permission-mask token
// ===========================================================================

/// Package-bound capability token. Binds a permission bitmask (over
...
mod tests {
    ...
    fn memory_permission_maps_to_a_capability() {
        ...
        // wallet/secret/chain permissions never project to a capability.
        let w =
