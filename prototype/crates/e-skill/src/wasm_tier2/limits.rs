//! `mnemos-e-skill::wasm_tier2::limits` — atom #256 · D.1.0 —
...
/// Which budget a declared demand exceeded. The meter (#264) maps any of these
...
// ===========================================================================
// 3. WasmRuntimeLimits — §4.2 explicit per-run budget
// ===========================================================================

/// §4.2 explicit per-run resource budget. Every field is an *upper bound*; a
...
/// conservative default). The public fields mirror the §4.2 canonical
