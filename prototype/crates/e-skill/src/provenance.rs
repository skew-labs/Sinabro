//! `mnemos-e-skill::provenance` — atom #246 · D.0.5 — the provenance node
//! and ancestor-chain validation.
//!
//! ## Canonical OUT (§4.1 — ATOM_PLAN line 200-206)
//!
//! - [`ProvenanceNode`] — §4.1 `{skill, package, parent, author,
...
//!   [`SkillPackageDigest32`], never a name) — §246 광기.
//!
...
//!
//! Chain validity ([`validate_ancestor_chain`]) is deterministic (§246
//! criterion): leaf-first linkage, strictly-decreasing depth, a unique
...
// ===========================================================================
// 1. ProvenanceNode — §4.1 single-parent content-addressed lineage
// ===========================================================================

/// One node in a skill's provenance chain (§4.1). `parent == None` marks a
