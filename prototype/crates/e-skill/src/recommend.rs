//! `mnemos-e-skill::recommend` — atom #304 · D.3.8 — the agent recommendation
//! context.
//!
...
//! every [`RecommendationCandidate`] row carries a permission preview (#301) and
...
/// budget is plain input data (a C-stage gas-trace summary), not a live call.
...
pub struct RecommendationContext {
    ...
    /// Tool ids available in the workspace (A command model).
...
pub struct RecommendationCandidate {
    ...
    /// The permission diff preview shown in this row (#301 — never omitted).
