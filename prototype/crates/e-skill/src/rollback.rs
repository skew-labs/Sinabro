//! Rollback / remove / quarantine plan.
//!
...
//!
//! This module defines [`LocalSkillState`]; other modules reuse it rather than
//! redefining it.

#![deny(missing_docs)]

/// Local skill lifecycle state. `#[repr(u8)]` 1-byte discriminant
/// (`1..=7`). Defined here.
