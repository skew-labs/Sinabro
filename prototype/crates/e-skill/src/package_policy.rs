//! `mnemos-e-skill::package_policy` — atom #243 · D.0.2 — the no-commerce
...
//! compatibility, author, and docs (§243 광기). Any money-shaped or
...
//!   and stable across TOML key order (§243 criterion): the verdict is a
