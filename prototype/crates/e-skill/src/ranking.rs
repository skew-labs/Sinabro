//! `mnemos-e-skill::ranking` — atom #303 · D.3.7 — the deterministic skill rank
//! score.
//!
//! Ranking is **not** popularity-only (§4.4 [`SkillRankScore`]). Eval, security,
...
/// Documented ranking weights. The first four feed the §4.4-recorded component
...
/// A deterministic rank score for one catalog entry (§4.4).
#[derive(Clone, Copy, Debug, Eq, PartialEq, Hash)]
