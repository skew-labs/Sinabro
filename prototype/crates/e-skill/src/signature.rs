//! Author signature over a skill package.
//!
//! ## Signature model
//!
//! - [`SkillPackageSignature`] — `#[repr(transparent)]` over the
//!   [`SignatureBytes`] (64 B). The signature covers the
...
//! compares it to the stored 64 bytes. This module performs **no live
//! signing ceremony and no wallet egress**.
//!
//! The signature is a **keyless, deterministic content-integrity
...
//!   the rejections the verifier enforces.
...
//! boundary, which owns the key surface this module is
//! forbidden to touch. This module builds the offline verify surface honestly,
...
// ===========================================================================
// 1. SkillPackageSignature — transparent wrapper over SignatureBytes
// ===========================================================================

/// Author signature over a package content digest.
/// `#[repr(transparent)]` over the [`SignatureBytes`] (64 B) so
...
impl SkillPackageSignature {
    ...
    /// Produce the content-binding signature for `(author,
