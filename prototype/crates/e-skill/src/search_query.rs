//! `mnemos-e-skill::search_query` — atom #302 · D.3.6 — the skill search query
//! grammar.
//!
//! Raw user text becomes a hashed intent plus parsed filters (§4.4
...
//! `SkillCompatibility` happens in the #300 solver; the index entry alone does
...
/// A parsed skill search query (§4.4).
#[derive(Clone, Copy, Debug, Eq, PartialEq, Hash)]
