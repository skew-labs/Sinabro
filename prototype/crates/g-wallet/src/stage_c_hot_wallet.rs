//! Stage C sponsor hot-wallet policy.
//!
//! Primary type: [`SponsorHotWalletPolicy`].
//!
//! # Invariants
//!
...
//!   address and the daily burn cap are the d-move canonical types, not
//!   re-minted.
//!
...
//! spend authorization remains behind the signer boundary.
...
/// Sponsor hot-wallet cap policy. Three typed fields, no key material.
