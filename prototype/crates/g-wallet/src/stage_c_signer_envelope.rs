//! Stage C exact signer envelope.
//!
//! Primary type: [`MainnetSignerEnvelope`].
//!
//! # Invariants
//!
...
//! * [`TimelockPolicy`](crate::stage_c_timelock::TimelockPolicy);
...
/// The exact bytes a mainnet signer commits to.
...
mod tests {
    ...
    fn c1_13_exact_digest_vector() {
        ...
        // ETA derives from the timelock min delay.
