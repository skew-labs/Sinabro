//! Stage C multisig roster.
//!
//! Primary type: [`MultisigRoster`].
//!
//! # Invariants
//!
...
//! * `Blake2b<U32>` — the keystore's `Blake2b-256` hashing convention
//!   (`g-wallet/src/keystore.rs:414`). No parallel digest is minted.
...
/// A mainnet multisig roster (canonical output).
///
...
/// hash; both [`MultisigRoster::from_signers`] and the proposal
