//! Stage B faucet / balance preflight (atom #154 · B.4.8, WorkPackage
//! B-WP-03).
//!
//! Canonical OUT (`MNEMOS_STAGE_B_ATOM_PLAN.md` §4.4): a testnet balance
//! preflight report. The madness spec: "Stage B uses testnet gas only. no
//! sponsor wallet, no Gas Station, no mainnet."
//!
//! # Madness invariants (§4.4 / atom #154)
//!
...
/// A testnet balance preflight report (§4.4 canonical OUT).
///
