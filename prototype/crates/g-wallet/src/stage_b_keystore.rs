//! Stage B encrypted keystore at rest, testnet policy (atom #147 · B.4.1,
//! WorkPackage B-WP-03).
//!
...
//! ([`StageBWalletError`]).
//!
//! # Madness invariants (§4.4 / atom #147)
//!
...
//! * Stage A §4.G: [`SealedKeypair`] (`keystore.rs:123`), its
...
mod tests {
    ...
    /// "plaintext key file path is rejected" madness invariant.
    #[test]
