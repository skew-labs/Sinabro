//! Stage C timelock policy.
//!
//! Primary type: [`TimelockPolicy`].
//!
//! # Invariants
//!
...
//! # Reuse
//!
//! * This policy is referenced by the multisig proposal / signer-envelope
//!   flow; it mints no new mainnet-state or address type.
