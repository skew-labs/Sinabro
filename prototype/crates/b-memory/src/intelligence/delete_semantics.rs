//! Delete semantics + tombstone policy.
//!
//! The bare [`DeleteSemantics`](crate::intelligence::DeleteSemantics) enum lives at
//! the module boundary so that
//! [`UserModelDelta`](crate::intelligence::user_model::UserModelDelta) can attach
//! a deletion mode. This module owns the **policy** over that enum: a
...
//!   [`crate::intelligence`]; this module
...
pub struct ResurrectionScan {
    ...
    /// Number of deleted memories that resurrected — always 0 by construction.
    pub deleted_resurrections_u64: u64,
}

impl ResurrectionScan {
    /// Whether the zero-resurrection criterion held (`deleted_resurrections_u64 == 0`).
    #[inline]
    #[must_use]
...
impl TombstonePolicy {
    ...
    /// insertion order. This is the value
