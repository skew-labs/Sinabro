//! User model delta (Stage D Cluster 6, atom #327 · D.5.6).
//!
...
//! [`UserModelDelta`] (§4.6) is the hashed snapshot of a model plus its
...
//! tombstone / resurrection-prevention **policy** over it is owned by atom #328
...
/// A hashed snapshot of a user model plus its deletion semantics (§4.6).
...
pub struct UserModelDelta {
    ...
    /// How deletions in this delta are handled (policy owned by atom #328).
